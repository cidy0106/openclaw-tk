...
import "./views/platform-manager/platform-manager.js";
import {
...
export function renderApp(state: AppViewState) {
  ...
  return html`
    ...
    >
            ...
            <div class="sidebar-shell__footer">
              <div class="sidebar-utility-group">
                <button
                  ...
                  @click=${() => state.openPlatformManager()}
                  title="${t("nav.platformManager") ?? "平台管理"}"
                >
                  <span class="nav-item__icon" aria-hidden="true">⚡</span>
                  ${
                    !navCollapsed
                      ? html`<span class="nav-item__text">${t("nav.platformManager") ?? "平台管理"}</span>`
                      : nothing
                  }
                </button>
                <a
      ...
      <platform-manager
        .open=${state.platformManagerOpen}
        @close=${() => state.closePlatformManager()}
      ></platform-manager>
      ${nothing}
    </div>
  `;
